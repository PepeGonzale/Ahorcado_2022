...
public class VentanaAhorcado extends javax.swing.JFrame {
        String [] palabras = {"TORRE", "APOLO", "AGUAS", "COCHE","PATOS","JORGE"};//palabra a adivinar
    //utilizamos este metodo para que nos saque una palabra al azar entre las 6 posibles.
     Random r = new Random();
     int n = r.nextInt(6);
     String palabraOculta = palabras [n];
    
    boolean partidaAcabada = false; //indica si la partida ha terminado
    int numeroFallos = 0; //numero de fallos 
     ...
     public void chequeaLetra(String letra){
       ...
       //todas las imagenes que vamos a utilizar estan aqui.
        ...
        switch (numeroFallos){
            ...
            case 5: nombreImagen = getClass().getResource("/imagenes/gameover.jpg"); break;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(panelAhorcado, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(94, 94, 94))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panelGuiones, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
